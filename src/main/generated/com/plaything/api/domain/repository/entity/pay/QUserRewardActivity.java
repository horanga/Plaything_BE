...
public class QUserRewardActivity extends EntityPathBase<UserRewardActivity> {
  ...
  public static final QUserRewardActivity userRewardActivity = new QUserRewardActivity(
      "userRewardActivity");
  private static final long serialVersionUID = -1237000533L;
  private static final PathInits INITS = PathInits.DIRECT2;
  public final NumberPath<Long> id = createNumber("id", Long.class);

  public final DateTimePath<java.time.LocalDateTime> lastAdViewTime = createDateTime(
      "lastAdViewTime", java.time.LocalDateTime.class);

  public final DatePath<java.time.LocalDate> lastLoginTime = createDate("lastLoginTime",
  ...
  public QUserRewardActivity(Class<? extends UserRewardActivity> type, PathMetadata metadata,
      PathInits inits) {
