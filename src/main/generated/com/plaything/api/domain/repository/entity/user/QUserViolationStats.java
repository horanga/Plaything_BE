...
public class QUserViolationStats extends EntityPathBase<UserViolationStats> {
  ...
  public static final QUserViolationStats userViolationStats = new QUserViolationStats(
      "userViolationStats");
  ...
  public final NumberPath<Long> reportViolationCount = createNumber("reportViolationCount",
      Long.class);
  ...
  public QUserViolationStats(Class<? extends UserViolationStats> type, PathMetadata metadata,
      PathInits inits) {
