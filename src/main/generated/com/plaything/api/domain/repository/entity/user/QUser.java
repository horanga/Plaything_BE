...
public class QUser extends EntityPathBase<User> {
    ...
    public QUser(Class<? extends User> type, PathMetadata metadata, PathInits inits) {
        ...
        this.credentials = inits.isInitialized("credentials") ? new QUserCredentials(forProperty("credentials")) : null;
        this.profile = inits.isInitialized("profile") ? new com.plaything.api.domain.repository.entity.user.profile.QProfile(forProperty("profile")) : null;
    }
