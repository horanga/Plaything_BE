...
public class QPointKey extends EntityPathBase<PointKey> {
  ...
  public final DateTimePath<java.time.LocalDateTime> expirationDate = createDateTime(
      "expirationDate", java.time.LocalDateTime.class);
  ...
  public final EnumPath<com.plaything.api.domain.key.constant.PointStatus> status = createEnum(
      "status", com.plaything.api.domain.key.constant.PointStatus.class);
