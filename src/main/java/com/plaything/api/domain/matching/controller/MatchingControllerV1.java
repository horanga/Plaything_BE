...
import static com.plaything.api.domain.matching.constants.MatchingConstants.EXPIRATION_DATE_PROFILE_ID;
import static com.plaything.api.domain.matching.constants.MatchingConstants.EXPIRATION_DATE_SKIP_COUNT;
...
public class MatchingControllerV1 {
  ...
  public UserMatchingResponse matching(
    ...
    return new UserMatchingResponse(
        matchingFacadeV1.findMatchingCandidates(user, CACHE_DURATION_DAY,
