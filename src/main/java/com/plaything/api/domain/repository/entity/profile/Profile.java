...
public class Profile {
  ...
  public void update(
    ...
    long countOfPrimaryTrait = personalityTrait.stream().filter(PersonalityTrait::isPrimaryTrait)
        .count();
  ...
  public List<ProfileImage> updateProfilePictures(List<String> picturesToRemove,
      List<ProfileImage> newProfileImages, Integer mainPhotoIndex, boolean shouldCancelMainPhoto) {

    if (shouldCancelMainPhoto) {
      this.profileImages.stream().filter(ProfileImage::isMainPhoto)
