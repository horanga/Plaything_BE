...
public class ProfileFacadeV1 {
  ...
  //TODO 비동기 처리할지 확인하기
  public void registerImages(List<ProfileImageRequest> images, String transactionId,
      String loginId) {
  ...
  public void updateImages(String loginId, List<ProfileImageRequest> newImages,
      String transactionId, List<String> imagesToRemove, Integer indexOfMainImage,
    ...
    try {
      profileImageServiceV1.updateImages(loginId, imagesToRemove, savedImages, indexOfMainImage,
          shouldCancelMainPhoto);
