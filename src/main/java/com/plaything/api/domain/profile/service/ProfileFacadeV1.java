...
public class ProfileFacadeV1 {
    ...
    public void registerProfile(ProfileRegistration registration, String loginId) {
        ...
        profileCommandServiceV1.registerProfile(registration, loginId, user);
    }
    ...
    public void updateProfile(ProfileUpdate updateRequest, String loginId) {
        ...
        profileCommandServiceV1.updateProfile(updateRequest, loginId, profile);
    }

    @Transactional(readOnly = true)
    public ProfileResponse getProfileByLoginId(String loginId) {
        return profileQueryServiceV1.getProfileByLoginId(loginId);
    }
