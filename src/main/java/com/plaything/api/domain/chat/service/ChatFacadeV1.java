...
public class ChatFacadeV1 {
  ...
  public List<ChatRoom> getChatRooms(String requesterLoginId, Long lastChatRoomId) {
    ...
    List<com.plaything.api.domain.repository.entity.chat.ChatRoom> chatRooms = chatRoomServiceV1.findChatRooms(
        requesterLoginId, lastChatRoomId);
  ...
  private Map<String, Profile> getProfileMap(
      List<com.plaything.api.domain.repository.entity.chat.ChatRoom> chatRooms,
  ...
  private List<ChatRoom> getChatRoomResponse(
      List<com.plaything.api.domain.repository.entity.chat.ChatRoom> chatRooms,
      Map<String, Profile> profileMap, String requestLoginId) {
    ...
    return chatRooms.stream()
        .map(chatRoom -> new ChatRoom(
            ...
            ChatProfile.toResponse(
                ...
                urlGenerator.getImageUrl(profileMap.get(getPartnerLoginId(chatRoom, requestLoginId))
                    .getMainPhotoFileName())
            )
        ))
        .toList();
  }

  private String getPartnerLoginId(
      com.plaything.api.domain.repository.entity.chat.ChatRoom chatRoom, String requesterNickname) {
