...
public class SessionValidator {
  ...
  public void validateSend(String authHeader, String sessionId, String destination,
    ...
    if (!matchingMap.containsKey(requesterLonginId)) {
      List<MatchingResponse> matchingResponse = matchingServiceV1.getMatchingResponse(
          requesterLonginId);
...
//        }
  ...
  private List<String> getMatchingPartner(String loginId,
      List<MatchingResponse> matchingResponses) {
