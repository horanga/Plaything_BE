...
public class UserGenerator {
    ...
    public UserGenerator(AuthServiceV1 authServiceV1, ProfileFacadeV1 profileFacadeV1, ProfileRepository profileRepository, MatchingFacadeV1 matchingFacadeV1) {
